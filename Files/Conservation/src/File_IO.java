...
public class File_IO {
	...
	public static void removeAnimal(String data) throws IOException{
		   {
		        try
		        {
		                BufferedReader file = new BufferedReader(new FileReader("C:/Users/deckl/eclipse-workspace/Clyde-Conservation/src/Animals.txt"));
		                String line;
		                String input = "";
		                while ((line = file.readLine()) != null) 
		                {
		                ...
		                FileOutputStream File = new FileOutputStream("C:/Users/deckl/eclipse-workspace/Clyde-Conservation/src/Animals.txt");
		                File.write(input.getBytes());
		                file.close();
		                File.close();
		        }
